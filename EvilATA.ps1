        ...
        try{
            ...
            if ($Id -and $Profile) {
                ...
                elseif ($result.type -eq "computer") {
                    ...
                    $result_profile.IpAddressToTimeMapping = $result_profile.IpAddressToTimeMapping | gm |? MemberType -eq "noteproperty" | select @{n="IdentityRefer";e={$Identity.samaccountname}},@{n="DNSHostName";e={$Identity.DNSHostName}},@{n="IPAddress";e={$_.name}},@{n="Date";e={(Get-Date $result_profile.IpAddressToTimeMapping.($_.name)).ToLocalTime()}}
